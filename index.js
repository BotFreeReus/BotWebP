...
const connectKeWA = () => {
const semar = makeWASocket({logger:pino({level:'silent'}),printQRInTerminal: true,auth: state,browser: ["ReusTis", "Dekstop", "3.0"]})
...
msg = denz.messages[0]
nomorOwner = ['6281222502055']
nomorDeveloper = ['62812225020t5']
